        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-400">
              India&apos;s premier MCX trading academy providing expert-led courses, live trading sessions, and professional mentorship.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/my-courses" className="text-sm hover:text-white transition-colors">
                  My Courses
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <div>
                  <p className="text-sm">+91 7717756371</p>
              ...
              <li className="flex items-start gap-2">
                ...
                <p className="text-sm">70/20, 3rd Floor, Swarajpuri Road, Gaya, Bihar - 823003</p>
              </li>
            </ul>
          </div>
        </div>
